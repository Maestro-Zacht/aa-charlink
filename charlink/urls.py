...
urlpatterns = [
    ...
    path(
        "admin/toggle_visible/<str:app_name>/",
        views.toggle_app_visible,
        name="toggle_app_visible",
    ),
    path(
        "admin/toggle_selection/<str:app_name>/",
        views.toggle_app_default_selection,
        name="toggle_app_default_selection",
    ),
]
